...
**Tests**: Automated tests are REQUIRED. Include tasks for unit, integration, or contract tests
based on feature risk.
...
- [ ] T018 [US1] Verify UX consistency for naming/messages/responses in docs and interfaces
...
- [ ] T025 [US2] Verify UX consistency for naming/messages/responses in docs and interfaces
...
- [ ] T031 [US3] Verify UX consistency for naming/messages/responses in docs and interfaces
...
- [ ] TXXX Performance verification against defined targets and constraints
- [ ] TXXX [P] Additional unit/integration/contract tests for risk hotspots
...
- Verify performance targets and UX consistency before closing a story
